...
// github.com/saulortega/pgeo.latlng is like github.com/saulortega/pgeo, but the points are represented as Lat/Lng instead of X/Y.
//
// Geometryc types:
